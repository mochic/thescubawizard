...
const SchedulingFormPlaceholder = styled(animated.div)`
  height: 100vh;
  width: 100vw;
  background: green;
`
...
const SchedulingPage = () => {
  ...
  //         <SchedulerContainer>
  //           <StatementContainer
  //             style={{ opacity: statementOpacity, transform: statementTransform }}
  //           >
  //             schedule a chat.
  //           </StatementContainer>
  //           {/* <FormContainer
  //             style={{
  //               visibility: formVisibility.interpolate(v =>
  //                 v === 1 ? 'visible' : 'hidden'
  //               ),
  //             }}
  //           /> */}
