...
const LandingPage = () => {
  ...
  //   } = useSpring({
  //     to: {
  //       dasharrayTop: visible ? '90, 100' : '0,100',
  //       dasharrayLeft: visible ? '90, 100' : '0,100',
  //       dasharrayRight: visible ? '90, 100' : '0,100',
  //       dasharrayBottom: visible ? '90, 100' : '0,100',
  //     },
  //   })

  const { dasharray, dashoffset } = useSpring({
    from: {
      dasharray: `1000,1000`,
      dashoffset: 1000,
    },
    to: {
      dasharray: visible ? `1000,1000` : `0,100`,
      dashoffset: visible ? 0 : 1000,
    },
    delay: 1000,
  ...
  return (
    <VisibilitySensor onChange={e => setVisible(e)}>
      <LandingPageContainer>
        <TitleContainer>
          <MainTitle dasharray={dasharray} dashoffset={dashoffset} />
        </TitleContainer>
      </LandingPageContainer>
    </VisibilitySensor>
  )
